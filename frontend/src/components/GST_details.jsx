...
const GST_details = ({finalcost ,setgstbill,element,weight}) => {
    ...
    return (
        <div className='h-full w-[93%] flex'>
            <div className='flex flex-col items-center justify-around w-[51%] h-[97%] m-3 bg-gradient-to-b from-black to-[#0d0d0d] shadow-[#f9fafb] border-amber-50 rounded-2xl space-y-9'>
            ...
            <div className='w-[48%] h-[97%] ml-1 m-3 bg-gradient-to-b from-black to-[#0d0d0d] rounded-2xl flex flex-col space-y-10 items-center'>
