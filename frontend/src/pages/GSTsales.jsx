...
const GSTsales = () => {
    ...
    const displaygstsales = async()=>{
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/gstsales`,{ withCredentials: true })
    ...
    const cleargstsales = async()=>{
        try{
            await axios.get(`${import.meta.env.VITE_BACKEND_URL}/gstsales/deletegstsales`,{ withCredentials: true })
    ...
    const searchgstsale = async(search_input)=>{
        ...
        try{
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/gstsales/billno/${parseInt(search_input)}`,{ withCredentials: true })
            setgstsales(response.data)
        }
        catch(err){
            console.error("Error adding sale:", err);
    ...
    const deletebybillno=async()=>{
        ...
        try{
            await axios.get(`${import.meta.env.VITE_BACKEND_URL}/gstsales/deletebybillno/${parseInt(selected)}`,{ withCredentials: true })
            await displaygstsales()
        }
        catch(err){
