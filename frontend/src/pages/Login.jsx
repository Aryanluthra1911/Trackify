    ...
    return (
        <div className='w-screen h-screen bg-gradient-to-b from-black via-[#1a1a1a] to-[#0d0d0d] text-white'>
            ...
            <div className='h-[90%] flex justify-center items-center'>
                <div className='h-120 w-120 bg-white/10 backdrop-blur-md border border-white/20  shadow-lg p-6 rounded-2xl flex flex-col items-center justify-around'>
                    <div className='h-[15%] w-[95%] flex items-start justify-around'>
                        <button className={` border-2 h-[90%] w-[47%] rounded-2xl  bg-gradient-to-b from-black via-[#1a1a1a] to-[#0d0d0d] text-gray-300  border-sky-400 text-2xl `} >Login</button>
                        <button  onClick={()=>{
                            navigate('/signup')
