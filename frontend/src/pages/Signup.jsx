    ...
    return (
        <div className='w-screen h-screen bg-gradient-to-br from-black via-zinc-900 to-black text-white overflow-hidden relative'>
            ...
            <div className='h-[90%] flex justify-center items-center relative z-10'>
                <div className='h-130 w-120 bg-black/50 backdrop-blur-2xl border border-white/10 hover:border-amber-400/30 shadow-2xl shadow-black/50 p-6 rounded-2xl flex flex-col items-center justify-around transition-all duration-700'>
                    ...
                    <div className='relative z-10 h-[15%] w-[95%] flex items-start justify-around'>
                        ...
                        >
                            <span className='transition-colors duration-300'>Login</span>
                        </button>
                        ...
                        <button className='group relative border-2 h-[90%] w-[47%] rounded-2xl overflow-hidden
                            ...
                            <div className='relative z-10 h-full flex items-center justify-center'>
                                <span className='group-hover:text-amber-100 transition-colors duration-300'>Signup</span>
                            </div>
                    ...
                    {/* Signup Button - styled exactly like home page buttons */}
